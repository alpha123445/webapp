...
--
-- Host: mysql.axiz.io
-- Generation Time: May 02, 2024 at 12:50 PM
...
--
-- Table structure for table `Conversation_Etat_Lieux`
--
...
CREATE TABLE `Conversation_Etat_Lieux` (
  ...
  `chemin_photo` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `id_etat` int NOT NULL,
  `noteco` int DEFAULT NULL,
  `notecli` int DEFAULT NULL,
  `id_piece` int DEFAULT NULL,
...
--
-- Dumping data for table `Conversation_Etat_Lieux`
--
...
--
-- Table structure for table `Etat_Lieux`
--
...
--
-- Dumping data for table `Etat_Lieux`
--
...
--
-- Table structure for table `LogementPeriode`
--
...
--
-- Dumping data for table `LogementPeriode`
--
...
CREATE TABLE `Logements` (
  ...
  `nom_logement` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `nb_pieces` int NOT NULL,
  `rue_logement` varchar(100) NOT NULL,
  `cp_logement` int NOT NULL,
...
CREATE TABLE `PromoCode` (
  `idCode` int NOT NULL,
  `Code` varchar(500) COLLATE utf8mb4_general_ci NOT NULL,
  `Type` int NOT NULL,
...
--
-- Indexes for table `Conversation_Etat_Lieux`
--
...
--
-- Indexes for table `LogementPeriode`
--
...
--
ALTER TABLE `Commercial`
  MODIFY `id_commercial` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `Conversation_Etat_Lieux`
--
ALTER TABLE `Conversation_Etat_Lieux`
  MODIFY `id_conversation` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT for table `Equipement`
--
ALTER TABLE `Equipement`
  MODIFY `id_equipement` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=194;

--
-- AUTO_INCREMENT for table `Etat_Lieux`
--
ALTER TABLE `Etat_Lieux`
  MODIFY `id_etat` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `LogementPeriode`
--
ALTER TABLE `LogementPeriode`
  MODIFY `id_periode` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;

--
-- AUTO_INCREMENT for table `Logements`
--
ALTER TABLE `Logements`
  MODIFY `id_logement` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=71;

--
-- AUTO_INCREMENT for table `Photos`
--
ALTER TABLE `Photos`
  MODIFY `id_photo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=162;

--
-- AUTO_INCREMENT for table `Pieces`
--
ALTER TABLE `Pieces`
  MODIFY `id_piece` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=275;

--
-- AUTO_INCREMENT for table `Reservation`
--
ALTER TABLE `Reservation`
  MODIFY `id_reservation` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
...
--
-- Constraints for table `LogementPeriode`
--
ALTER TABLE `LogementPeriode`
